...
public:
	...
	virtual int GetCurrStepNum() const;
	...
	virtual double GetTargetFootHeight(double time, int currStepNum) const;
	virtual double GetTargetFootLength(double time, int currStepNum) const;
